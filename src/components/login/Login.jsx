  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm  flex flex-col justify-center align-center ">
        <h1 className="mt-5 text-center text-3xl xl:text-4xl xl:font-extrabold font-bold leading-5  sm:font-serif" >Expanse Calculator</h1>
      ...
      {/* Form starts from here */}
        ...
        <Link to="/signup" className="font-semibold text-1xl text-indigo-600 hover:text-indigo-500">Don't have an account?</Link>
      </div>
      </div>
    </div>
